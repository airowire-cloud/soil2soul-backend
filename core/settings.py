"""
Django settings for soil_soul_project project.
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-soil-soul-secret-key-change-in-production')
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@soilandsoul.com')
